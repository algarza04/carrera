//Álvaro García Zafra
//c++ -std=c++11 -pthread -o ejecutivo2 ejecutivo2.cpp
// -----------------------------------------------------------------------------
//
...
//  *---------*----------*---------*--------*
//  | A B D | B C D | A B D | B D |
//  *---------*----------*---------*--------*
//
//¿Cuál es el mínimo tiempo de espera que queda al final de las iteraciones del ciclo secundario con tu solución?	50ms	(en las 3 primeras)
//¿Cuál es el máximo tiempo de espera que queda al final de las iteraciones del ciclo secundario con tu solución?	250ms
// Historial:
...
void TareaD() { Tarea( "D", milliseconds(100) );  }
   ...
   while( true ) // ciclo principal
   {
      ...
      for( int i = 1 ; i <= 4 ; i++ ) // ciclo secundario (4 iteraciones)
      {
         ...
         time_point<steady_clock> fin_sec = steady_clock::now();
			...
			cout << "Ha habido un retraso de: " << retraso << " milisegundos" << endl;
      }
   }
}
