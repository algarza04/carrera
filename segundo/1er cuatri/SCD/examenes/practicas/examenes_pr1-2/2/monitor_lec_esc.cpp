...
void Lec_Esc::ini_revision(){
	...
	cout << "			+Revisora comienza la revisión" << endl;
}
...
void Lec_Esc::fin_revision(){
	...
	cout << "			-Revisora termina la revisión" << endl;
}
...
void revisora( MRef<Lec_Esc> monitor ){
	while ( true ) {
...
int main()
{
   ...
   thread hebras_lectoras[num_lec], hebras_escritoras[num_esc], hebra_revisora(revisora,  monitor);
