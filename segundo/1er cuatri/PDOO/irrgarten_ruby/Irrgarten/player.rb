...
class Player < LabyrinthCharacter
  ...
  private :receive_weapon, :receive_shield,:new_weapon, :new_shield, :manage_hit, :reset_hits, :got_wounded, :inc_consecutive_hits
  protected :defensive_energy, :sum_shields, :sum_weapons
end
